...
import { MealTypesService} from "./mealtypesService";

export class MealTypesController extends BaseController {
    constructor() {
        const mealtypesService = new MealTypesService()
        super( mealtypesService );
    }
