...
recipient_emails = ['adil.khursheed@tekrevol.com', 'faiz@tekrevol.com', 'khurram.munir@tekrevol.com']  # Add more recipient emails as needed
...
if quality_gate_status == 'ERROR':
    message['Subject'] = 'Pipeline Failure Mynder-Backend'
    body = 'The pipeline has failed Mynder-Backend. Quality gate not passed.\n\n'
else:
    message['Subject'] = 'Pipeline Failure Mynder-Backend'
    body = 'The pipeline has failed Mynder-Backend. Quality gate not passed.\n\n'
